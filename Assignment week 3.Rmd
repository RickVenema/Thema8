...
In figure 2a and 2b the model is shown with the experimental data. With adding this data, the model can be
...
average on that timepoint is a bit higher than expected from the model. Furthermore is there a clear difference
