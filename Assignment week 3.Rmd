...
```{r plots validation mRNA, echo=F, fig.cap="The difference in concentration of mRNA by dose 0.1 and dose 0.3", fig.height=3.5, fig.pos='H'}
par(mfrow=c(1,2))
...
Figure 3 shows the difference in concentration of mRNA with dose 0.3 and dose 0.1, This difference is visable in the height of the steady state of the model. With a dose 0.3 the steady state is lower than the steady state of dose 0.1. This can be seen in figure 3a

```{r plots validation MPL, echo=F, fig.cap="LORUM IPSUM DOLAR SIT AMET", fig.height=3.5, fig.pos='H'}
par(mfrow=c(1,2))
