...
```{r plots validation, echo=F, fig.cap="Graphs showing the experiment data in combination with the model"}
# Rick Venema
# 368044
# k.f.venema@st.hanze.nl
...
plot(dose_0.3$time, dose_0.3$Free_receptor, ylim=c(0,500), col="red", type="l", xlim=c(-1, 175),
     main="Concentration of Free receptor with dose 0.3",
...
plot(dose_0.1$time, dose_0.1$Free_receptor, ylim=c(0,500), col="red", type="l", xlim=c(-1, 175),
     main="Concentration of Free receptor with dose 0.1", 
...
plot(dose_0.3$time, dose_0.3$mRNA, col="red", type="l", xlim=c(-1, 175),
     main = "Concentration of mRNA with dose 0.3",
     sub = "(c)", xlab = "Timeunits", ylab = "mRNA",
     cex.main = 1 )
...
plot(dose_0.1$time, dose_0.1$mRNA, col="red", type="l", xlim=c(-1, 175),
     main="Concentration of mRNA with dose 0.1",
     sub = "(d)", xlab = "Timeunits", ylab="mRNA",
     cex.main = 1)
points(data_0.1$time,data_0.1$mRNA)
points(out0.1$time,out0.1$mRNA.R, type="l")

# Plots of concentration MPL
plot(dose_0.3$time, dose_0.3$MPL_conc, col="red", type="l", ylim=c(0,250), xlim=c(-1, 175),
     main = "Concentration of MPL with dose 0.3",
     sub = "(e)", xlab = "Timeunits", ylab = "MPL",
     cex.main = 1)
points(data_0.3$time, data_0.3$MPL_conc)
points(out0.3$time, out0.3$DR, type="l")

plot(dose_0.1$time, dose_0.1$MPL_conc, col="red", type="l", ylim=c(0,250), xlim=c(-1, 175),
     main = "Concentration of MPL with dose 0.1",
     sub = "(f)", xlab = "Timeunits", ylab = "MPL",
     cex.main = 1)
