...
## SOC stocks -BASThi
The model for the SOC stocks is obtained from Cardinael et al., 2015 Geoderma\cite{CardinaelGeoderma}. This model initalizes some values, such as a matrix with values of the clay, and generates a sequence for the humufied layer. It gets also a value from the moyano model: the moist in the clay.
...
After this the Diameter at breast height (DBH) is calculated. The 
-- berekent startwaarden voor hoeveelheid koolstof in de grond
-- berekent hoeveel koolstof in de grond komt
-- berekent hoeveel koolstof uit de grond gaat
=======
