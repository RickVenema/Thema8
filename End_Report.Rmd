...
abstract: SOC storage models can give better insights in the amount of carbon in the soil. Existing models are not versatile. Existing models were examined to make them usable for further work with the models. Eventually a lot of the model could be simplified, there were however parts that could not be simplified. We used the model from Cardinael et al. 2018\cite{Cardinael18}. This model represents the SOC storage in the soil. The model was taken apart and the parts were examined to understand the code and what it does. The first idea was to add a nitrogen model to the code, this was however not possible due to the hard 
output: 
  pdf_document:
    toc: False
